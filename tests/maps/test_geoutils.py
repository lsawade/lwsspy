'''
:copyright:
   LWSSPY development (makus@gfz-potsdam.de).
:license:
...
Created: Sunday, 2021.10.10 13:20 am
Last Modified: Sunday, 2021.10.10 13:20 am
...
def testspacing():
    ...
    lon, lat = lstat.even2Dpoints(10, 340, 160, mind)

    # Compute GCTrack
    qlat, qlon, qdists = lmap.gctrack(lat, lon, d)
...
def testspacing():
    ...
    d = d[0]
    # Create randomly but evenly distirbuted waypoints.
    lon, lat = lstat.even2Dpoints(2, 340, 160, mind)

    # Compute GCTrack
    qlat, qlon, qdists, updated_dists = lmap.gctrack(
