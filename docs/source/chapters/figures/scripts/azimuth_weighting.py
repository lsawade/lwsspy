...
width = 360
height = 180
x, y = lwsspy.statistics.even2Dpoints(100, width, height, 10)
x1, y1 = lwsspy.statistics.even2Dpoints(50, 60, 40, 1)
x2, y2 = lwsspy.statistics.even2Dpoints(50, 50, 120, 3)
...
plt.savefig(os.path.join(lwsspy.base.DOCFIGURES, "azimuth_weighting.pdf"))
plt.savefig(os.path.join(lwsspy.base.DOCFIGURES, "azimuth_weighting.svg"))
plt.show()
